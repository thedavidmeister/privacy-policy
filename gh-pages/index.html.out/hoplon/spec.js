...
var elem = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16493,(0),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16493,(1),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16493,(2),null);
...
var elem = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16497,(0),null);
var key = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16497,(1),null);
var val = cljs.core.nth.cljs$core$IFn$_invoke$arity$3(vec__16497,(2),null);
var temp__5288__auto__ = cljs.core.namespace(key);
if(cljs.core.truth_(temp__5288__auto__)){
var n = temp__5288__auto__;
return cljs.core.keyword.cljs$core$IFn$_invoke$arity$2(n,"*");
...
cljs.spec.alpha.def_impl(cljs.core.cst$kw$hoplon$spec_SLASH_do_BANG_,cljs.core.list(cljs.core.cst$sym$cljs$spec$alpha_SLASH_multi_DASH_spec,cljs.core.cst$sym$hoplon$spec_SLASH_do_BANG_,cljs.core.cst$kw$hoplon$spec_SLASH_do_BANG_),cljs.spec.alpha.multi_spec_impl.cljs$core$IFn$_invoke$arity$3(cljs.core.cst$sym$hoplon$spec_SLASH_do_BANG_,new cljs.core.Var(function(){return hoplon.spec.do_BANG_;},cljs.core.cst$sym$hoplon$spec_SLASH_do_BANG_,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$ns,cljs.core.cst$kw$name,cljs.core.cst$kw$file,cljs.core.cst$kw$end_DASH_column,cljs.core.cst$kw$column,cljs.core.cst$kw$line,cljs.core.cst$kw$end_DASH_line,cljs.core.cst$kw$arglists,cljs.core.cst$kw$doc,cljs.core.cst$kw$test],[cljs.core.cst$sym$hoplon$spec,cljs.core.cst$sym$do_BANG_,"/home/circleci/.boot/cache/tmp/home/circleci/repo/4e/-1zzjnu/index.html.out/hoplon/spec.cljs",14,1,36,36,cljs.core.List.EMPTY,null,(cljs.core.truth_(hoplon.spec.do_BANG_)?hoplon.spec.do_BANG_.cljs$lang$test:null)])),cljs.core.cst$kw$hoplon$spec_SLASH_do_BANG_));
cljs.spec.alpha.def_impl(cljs.core.cst$kw$hoplon$spec_SLASH_on_BANG_,cljs.core.list(cljs.core.cst$sym$cljs$spec$alpha_SLASH_multi_DASH_spec,cljs.core.cst$sym$hoplon$spec_SLASH_on_BANG_,cljs.core.cst$kw$hoplon$spec_SLASH_on_BANG_),cljs.spec.alpha.multi_spec_impl.cljs$core$IFn$_invoke$arity$3(cljs.core.cst$sym$hoplon$spec_SLASH_on_BANG_,new cljs.core.Var(function(){return hoplon.spec.on_BANG_;},cljs.core.cst$sym$hoplon$spec_SLASH_on_BANG_,cljs.core.PersistentHashMap.fromArrays([cljs.core.cst$kw$ns,cljs.core.cst$kw$name,cljs.core.cst$kw$file,cljs.core.cst$kw$end_DASH_column,cljs.core.cst$kw$column,cljs.core.cst$kw$line,cljs.core.cst$kw$end_DASH_line,cljs.core.cst$kw$arglists,cljs.core.cst$kw$doc,cljs.core.cst$kw$test],[cljs.core.cst$sym$hoplon$spec,cljs.core.cst$sym$on_BANG_,"/home/circleci/.boot/cache/tmp/home/circleci/repo/4e/-1zzjnu/index.html.out/hoplon/spec.cljs",14,1,44,44,cljs.core.List.EMPTY,null,(cljs.core.truth_(hoplon.spec.on_BANG_)?hoplon.spec.on_BANG_.cljs$lang$test:null)])),cljs.core.cst$kw$hoplon$spec_SLASH_on_BANG_));
